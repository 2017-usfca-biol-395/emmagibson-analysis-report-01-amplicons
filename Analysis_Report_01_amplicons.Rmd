...
```{r phylogenies common in male and female hands}
...
plot_richness(phyloseq_obj,
              ...
              color = "sex_s") +
  xlab("Sample sex") +
  ggtitle("Alpha diversiy in male vs female hands") +
  theme(axis.text.x = element_text(angle = 0, hjust = 1)) +
  geom_jitter(width = 0.2) +
  theme_bw()
```

Fig 1: Alpha diversity measures of the two sample types, colored by gender.
